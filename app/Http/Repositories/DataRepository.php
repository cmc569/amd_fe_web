...
class DataRepository
{
    ...
    {
        if ($start && $end) {
            return $this->customers->select('ip', 'name', 'title', 'company', 'tel', 'mobile', 'email', 'contact', 'created_at')->whereBetween('created_at', [$start, $end])->orderBy('created_at', 'desc')->get()->unique('mobile');
        }
