    ...
    <aside class="sidebar">
      ...
      <div class="sidebar__scroll">
        ...
        <div class="sidebar__nav">
          <a href="{{ route('dashboard') }}" class="nav-list{{ request()->routeIs('dashboard') ? ' active' : ''}}"><i class="far fa-fw fa-chart-bar"></i>活動網頁數據</a>
          <a href="{{ route('userInfo') }}" class="nav-list{{ request()->routeIs('userInfo') ? ' active' : ''}}"><i class="fas fa-fw fa-list"></i>使用者資訊</a>
        </div>
      </div>
    </aside>
